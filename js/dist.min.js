...
/**************************************//* yourcare v0.0.1 (2013-10-06) - john rodler */
var YC={init:function(){this.Nav.init()}};$(document).ready(function(){YC.init()});var YC_App=angular.module("YC_App",["ngRoute"]);YC_App.config(function($routeProvider){$routeProvider.when("/home",{templateUrl:"views/home.html"}).when("/health",{templateUrl:"views/health.html"}).when("/goals",{templateUrl:"views/goals.html"}).when("/calendar",{templateUrl:"views/calendar.html"}).when("/community",{templateUrl:"views/community.html"}).otherwise({redirectTo:"/home"})}),YC_App.controller("NavCtrl",function($scope,$location){$scope.isActive=function(route){return route===$location.path()},$scope.isNotActive=function(route){return route!==$location.path()}}),YC.Debug=!0,YC.Nav={sub_nav:$("header .submenu"),home_link:$("header a.home"),main_nav_links:$("header nav.main ul a"),status_nav_links:$("header .statusbar ul a"),status_search_link:$("header .statusbar ul a.search"),status_search_panel:$("header .statusbar ul li.status-search"),status_search_box:$("header .statusbar ul li.status-search .searchbox"),status_search_input:$("header .statusbar ul li.status-search .searchbox input"),sub_nav_links:$("header .submenu ul a"),status_search_flag:!1,nav_timer_delay:600,init:function(){this.setupHomeLinks(),this.setupStatusMenuLinks(),this.setupMainMenuLinks(),this.setupSubNavLinks(),this.setupStatusSearch()},setupHomeLinks:function(){this.home_link.bind("click",function(){YC.Nav.clearActiveLinks(YC.Nav.status_nav_links),YC.Nav.clearActiveLinks(YC.Nav.main_nav_links),YC.Nav.toggleStatusSearch("kill")})},setupStatusMenuLinks:function(){this.status_nav_links.each(function(){$(this).bind("click",function(e){e.preventDefault(),YC.Nav.clearActiveLinks(YC.Nav.status_nav_links),$(this).hasClass("search")||(YC.Nav.toggleStatusSearch("kill"),$(this).addClass("active"))})})},setupMainMenuLinks:function(){this.main_nav_links.each(function(){$(this).bind("click",function(){YC.Nav.clearActiveLinks(YC.Nav.main_nav_links),YC.Nav.clearActiveLinks(YC.Nav.status_nav_links),YC.Nav.sub_nav.addClass("active"),$(this).addClass("active")})})},setupSubNavLinks:function(){this.sub_nav_links.each(function(){$(this).bind("click",function(e){e.preventDefault(),YC.Nav.sub_nav_links.removeClass("active"),$(this).addClass("active")})})},clearActiveLinks:function(link_set){link_set===this.status_nav_links?link_set.removeClass("active"):link_set===this.main_nav_links?(link_set.removeClass("active"),YC.Nav.sub_nav.removeClass("active")):YC.Debug&&console.error("nav.js : YC.Nav.clearActiveLinks() - Fail")},setupStatusSearch:function(){this.status_search_link.bind("click",function(e){e.preventDefault(),YC.Nav.toggleStatusSearch()}),this.status_search_input.on("focus blur",function(){YC.Nav.toggleAutofill($(this))})},showStatusSearch:function(){this.status_nav_links.addClass("inactive"),this.status_search_panel.addClass("active"),setTimeout(function(){YC.Nav.status_search_box.fadeIn(),YC.Nav.status_search_flag=!0},this.nav_timer_delay)},hideStatusSearch:function(){this.status_search_box.fadeOut(),setTimeout(function(){YC.Nav.status_search_panel.removeClass("active"),YC.Nav.status_nav_links.removeClass("inactive"),YC.Nav.status_search_flag=!1},this.nav_timer_delay)},toggleStatusSearch:function(kill){kill&&!this.status_search_flag?this.hideStatusSearch():this.status_search_flag?this.hideStatusSearch():this.showStatusSearch()},toggleAutofill:function(input){""===input.val()?input.val("Search"):"Search"===input.val()&&input.val("")}},function(){for(var method,noop=function(){},methods=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],length=methods.length,console=window.console=window.console||{};length--;)method=methods[length],console[method]||(console[method]=noop)}();